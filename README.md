...
- Authorised editor: `ansarmedia@ansarschool.in`
...
Choose **Login** on the public map and authenticate with Google. The website normalizes and compares the returned verified email address. Only an exact match for `ansarmedia@ansarschool.in` opens the editor; every other account is signed out.
